...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView bemVindo = (TextView) navigationView.getHeaderView(0).findViewById(R.id.home_tvName);
        TextView email = (TextView) navigationView.getHeaderView(0).findViewById(R.id.home_tvEmail);
        Toolbar toolbar = findViewById(R.id.toolbar);

        // Obter o valor do email que está guardado em SharedPreferences
        ...
        bemVindo.setText("Bem-vindo utilizador!");
    ...
    // Se o utilizador clicar no botão voltar, uma alertDialog vai aparecer a pedir confirmação
    @Override
